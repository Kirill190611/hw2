...
* 7 - в файле GreetingContainer.tsx дописать логику функций pureAddUser, pureOnBlur, pureOnEnter и проверить их тестами + (нужно протипизировать)
* 8 - в файле GreetingContainer.tsx вычислить количество добавленных и имя последнего (totalUsers, lastUserName) +
* 9 - в файле Greeting.tsx дописать типизацию пропсов (нужно протипизировать) +
